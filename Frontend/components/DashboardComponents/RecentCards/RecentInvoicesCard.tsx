  ...
  return (
    ...
    >
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="min-w-max">Sr. No.</TableHead>
            <TableHead className="min-w-max">Client</TableHead>
            <TableHead className="min-w-max">Total</TableHead>
                  ...
                  variant={
                    {
                      Pending: "waiting",
                      Sent: "success",
                    }[cl.status] as keyof typeof badgeVariants
                  }
                >
                  {cl.status}
                </Badge>
